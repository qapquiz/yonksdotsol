...
Staging area for unprocessed info. Drop notes, reference material, or raw docs here. After processing into `docs/wiki/`, the source file stays but its content is replaced with a brief summary + link to the wiki page.
...
1. Drop file here (e.g. `raw/new-feature-notes.md`)
2. Agent processes into `docs/wiki/` (entity/concept/guide)
3. Update this README with status
4. Keep raw file for reference — do not delete
